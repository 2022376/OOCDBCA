...
public class CCT {
    ...
    private static Admin authenticateAdmin(SystemManager systemManager, Scanner scanner) {
        ...
        if (adminUsername.equals("CCT") && adminPassword.equals("Dublin")) {
            // Credenciais do administrador estão corretas
    ...
    private static void regularUserMenu(SystemManager systemManager, Scanner scanner) {
        System.out.println("\nLogin ou Registro do Usuário Regular");
        System.out.print("Username: ");
        ...
        if (regularUser == null) {
            ...
            System.out.println("Falha na autenticação do usuário regular. Encerrando o programa.");
            return;
        }
